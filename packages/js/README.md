...
**BIR (Bureau of Internal Revenue) tax utilities for the Philippines** — VAT, percentage tax, and a reference list of common BIR forms. JavaScript + PHP, MIT-licensed.

Companion to [ph-payroll](https://github.com/kon2raya24/ph-payroll), which covers the employee side (SSS / PhilHealth / Pag-IBIG / 13th-month / BIR withholding tax on compensation). This package covers the **non-employee** side: VAT on goods and services, percentage tax for small non-VAT businesses, and form references.
...
- **EWT (Expanded Withholding Tax)** — professional fees, rentals, commissions
- **ATC (Alphanumeric Tax Code) reference**
- **Documentary Stamp Tax (DST)**
- **BIR RDO (Revenue District Office) directory**
- **BIR Form 2316 generator** — likely lands in `@ph-dev-utils/payroll` v0.4 instead
