...
// Individual income tax — graduated TRAIN vs flat 8% option
...
computeEWT(100000, 'professional_individual'); // 10% default (5% only when the payee qualifies)
listEwtCategories();                           // 8 common EWT categories
...
| Percentage tax | 3% (1% historical) | Tax Code § 116 / RA 11534 | reverted 2023-07-01 |
...
- **Documentary Stamp Tax (DST)** — deferred pending verification of the 2025 **CMEPA (RA 12214)** rate revisions; the schedule is currently in flux and public sources disagree, so no guessed figures.
- **ATC (Alphanumeric Tax Code) reference** — confirm the EWT ATC against BIR Form 0619-E / 1601-EQ.
- **Full EWT schedule** beyond the common categories; **BIR RDO directory**.
